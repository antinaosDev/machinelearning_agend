...
# ==================== PANTALLA 3: HISTORIA DEL PROYECTO ====================
    ...
    st.markdown("""<div style="text-align: center; padding: 3rem 2rem; max-width: 56rem; margin: 0 auto; background: linear-gradient(135deg, #022448 0%, #1e3a5f 100%); border-radius: 1rem; color: white;"><p style="font-size: 1.5rem; font-weight: 600; font-style: italic; line-height: 1.6; color: white;">«Los datos sin contexto son solo ruido. El modelo detecta los bloques duros que los promedios ocultan.»</p></div>""", unsafe_allow_html=True)
